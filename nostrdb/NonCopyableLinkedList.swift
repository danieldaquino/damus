...
struct NonCopyableLinkedList<T: ~Copyable>: ~Copyable {
    ...
    func forEachItem<Y>(_ borrowingFunction: ((_ index: Int, _ item: borrowing T) throws -> LoopCommand<Y>)) throws -> Y?  {
        var indexCounter = 0
    ...
    func useItem<Y>(at index: Int, _ borrowingFunction: ((_ item: borrowing T) throws -> Y)) throws -> Y? {
