        ...
        func snapshot() {
            Task {
                ...
                snapshotTask = Task {
                    ...
                    // Create a database snapshot for extensions before closing
                    let snapshotManager = DatabaseSnapshotManager(ndb: self.damus_state.ndb)
                    do {
                        try await snapshotManager.performSnapshot()
